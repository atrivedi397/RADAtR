...
class EditTimeTable:
    def __init__(self, base=None, heading=None):
        ...
        if heading is None:
            self.heading = 'Oops, Edit time-table window isn\'t working yet.'
        ...
        self.timeTableEditWidget = QWidget(base)

        # layout for template
        self.incompleteWorkTemplateLayout = QVBoxLayout(self.timeTableEditWidget)
